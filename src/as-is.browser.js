...
const otherTypes = [
    { alias: ['Array', 'array'], method4type: 'array' },
...
class Checker {
    ...
    static empty(params) {
        ...
        let out;
        switch (true) {
            case Checker.constructorTc([arg, 'object']): out = !Object.keys(arg).length;
                break;
            case Checker.constructorTc([arg, 'map']): out = !arg.size;
                break;
            case Checker.constructorTc([arg, 'set']): out = !arg.size;
                break;
